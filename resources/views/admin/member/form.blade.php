                  ...
                  <form method="post" id="modal_form" class="form-horizontal" enctpye="multipart/form-data">
                        <div class="modal-body">
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                          <select name="member_kelamin" id="member_kelamin" class="form-control">
                              ...
                              <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                          <input type="text" name="member_hp" id="member_hp" class="form-control" autocomplete="off" autofocus>
                                    </div>
                              </div>
                              <div class="hidden">
